...
def train(args):
    ...
    df_train_animal = pd.read_csv('./')
    df_train_height = pd.read_csv('./')
    ...
    df_dev_animal = pd.read_csv('./')
    df_dev_height = pd.read_csv('./')
    df_test_animal = pd.read_csv('./')
    df_test_height = pd.read_csv('./')
    df_test_animal_wiki = pd.read_csv('./')
    df_test_height_wiki = pd.read_csv('./')
